...
- [X] export script
- [ ] shell script to set up environment for jetson
  - system dependencies (mirrors dockerfile)
  - source and activate venv (check creation)
  - pytorch compatible with current JetPack from Nvidia's PyPi
